...
#     df_f = pd.read_excel (r'C:\Users\twi\Downloads\Uniaxial_dataV1.xlsx',sheet_name=list_f[f_sim])
...
#     label = df_info.iloc[f_sim:f_sim+1,0:1]
#     label = pd.DataFrame(label)
#     label = label.reset_index(drop=True)
    
#     f_id = df_info.iloc[f_sim:f_sim+1,2:3]
#     f_id = pd.DataFrame(f_id)
#     f_id = f_id.reset_index(drop=True)
    
    
#     df_f = pd.concat([sim_id,ft_2, df_f_unif_stress, label, f_id], axis=1)
#     df_f.columns = ['Sim_id','stress_yeld_div_E','stress_max','stress_min','sigma_PD','f']
#     df_2 = df_f
...
df_f.to_csv(r'F:\PC_LABMETRO\TC_2\A04\analysis_2_only_plotting_results_Colab_does_not_work_well\total_df_t1.csv',index=False)
...
#df_f.to_csv(r'C:\Users\twi\Desktop\TC_2\A04\pre_processing\dataset_uniform_stress_test_1_all_simulations.csv',index=False)
